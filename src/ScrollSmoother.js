    ...
    function ScrollSmoother(t) {
        ...
        function La(t, e) {
            ...
            var r = isNaN(e.ratio) ? 1 : e.ratio,
                ...
                s = e.pins || [],
                a = s.offset || 0,
                l = (e._startClamp && e.start <= 0) || (e.pins && e.pins.offset) ? 0 : e._endClamp && e.end === v() ? 1 : 0.5;
            return (
                ...
                if (a) {
                    ...
                    var t = (function _autoDistance(e, t) {
                        var r,
                            ...
                            f = -c * t;
                        return (
                            0 < c && ((n = 0.5 == (r = s.height / (U.innerHeight + s.height)) ? 2 * s.height : 2 * Math.min(s.height, Math.abs((-c * r) / (2 * r - 1))) * (t || 1)), (f += t ? -n * t : -n / 2), (c += n)),
                            { change: c, offset: f }
                        );
                            ...
                            onUpdate: function onUpdate(e) {
                                ...
                                if (e.offset) {
                                    if (i) {
                                        for (r = -N, n = e.end; i--; ) {
                                            if ((t = p[i]).trig.isActive || (r >= t.start && r <= t.end))
                                                return void (l && ((t.trig.progress += t.trig.direction < 0 ? 0.001 : -0.001), t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(g.y), -F, !0), M && l.progress(1)));
                                    ...
                                    m.length &&
                                        ...
                                        l ? (l.resetTo("y", o, -F, !0), M && l.progress(1)) : ((g.y = o + "px"), g.renderTransform(1));
                                }
                            },
                        }))
                    ),
        ...
        var n,
            ...
            E = t.effectsPrefix || "",
            k = Y.getScrollFunc(U),
            H = 1 === Y.isTouch ? (!0 === m ? 0.8 : parseFloat(m) || 0) : 0 === _ || !1 === _ ? 0 : parseFloat(_) || 0.8,
            A = (H && +t.speed) || 1,
            N = 0,
            F = 0,
            M = 1,
        ...
        Pa(),
            ...
            (this.content = function (e) {
                if (arguments.length) {
                    ...
                    return t !== n && ((c = (n = t).getAttribute("style") || ""), L && L.observe(n), I.set(n, { overflow: "visible", width: "100%", boxSizing: "border-box", y: "+=0" }), H || I.set(n, { clearProps: "transform" })), this;
                }
                return n;
            }),
        ...
        O.forEach(function (e) {
            ...
            (i = Y.create({
                ...
                onRefresh: function onRefresh(e) {
                    e.animation.invalidate(),
                        ...
                        (B.y = -k() * A),
                        Ga(B.y),
                        M || (h && (g = !1), e.animation.progress(I.utils.clamp(0, 1, u / A / -e.end))),
            ...
            (this.kill = this.revert = function () {
                ...
                var r = Y.defaults({});
                r && r.scroller === S && Y.defaults({ scroller: U }), o.normalizer && Y.normalizeScroll(!1), clearInterval(a), (Q = null), L && L.disconnect(), K.style.removeProperty("height"), U.removeEventListener("focusin", Ka);
            }),
